...
(function ($) {
  ...
  $.fn.jMyCarousel = function (o) {
    ...
    return this.each(function () {
      ...
      div
        .css("overflow", "hidden") // Overflows - works in FF
      ...
      if (defaultBtn && o.auto !== true) {
        //Add buttons when necessary (In default mode and not auto)
      ...
      if (o.mouseWheel && div.mousewheel) {
        div.mousewheel(function (e, d) {
          if (
            (!o.circular && (d > 0 ? curr + divSize < ulSize : curr > 0)) ||
            o.circular
          ) {
      ...
      function forward(stepsize, once) {
        ...
        ul.animate(
          ...
          function () {
            ...
            if (o.circular) {
              if (
                curr + (o.vertical ? divVSize : divSize) + liSize >=
                allEltsSize
              ) {
