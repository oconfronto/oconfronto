...
function createChatBox(chatboxtitle, minimizeChatBox) {
  ...
  $(" <div />")
    ...
    .addClass("chatbox")
    .html(
      '<div class="chatboxhead" onclick="javascript:toggleChatBoxGrowth(\'' +
        chatboxtitle +
        '\')"><div class="chatboxtitle"><b>' +
        chatboxtitle +
        '</b></div><div class="chatboxoptions"><b>--</b>&nbsp&nbsp&nbsp<a href="javascript:void(0)" onclick="javascript:closeChatBox(\'' +
        chatboxtitle +
  ...
  $("#chatbox_" + chatboxtitle + " .chatboxtextarea")
    .blur(function () {
      chatboxFocus[chatboxtitle] = false;
      $("#chatbox_" + chatboxtitle + " .chatboxtextarea").removeClass(
    ...
    .focus(function () {
      ...
      $.cookie("#chatbox_" + chatboxtitle + " .chatboxhead", 1, {
        path: "/",
        expires: -1,
      });
    });
    ...
    if (newMessages[x] == true) {
      if (chatboxFocus[x] == false) {
        ...
        if ($.cookie("#chatbox_" + x + " .chatboxhead") == null) {
          $("#playSound").html(
            "<embed src='static/bip2.mp3' hidden='true' autostart='true' loop='false'>"
          );
          $.cookie("#chatbox_" + x + " .chatboxhead", 1, {
            path: "/",
            expires: 1,
          });
        }
...
function closeChatBox(chatboxtitle) {
  $("#playSound").html(
    "<embed src='static/msg.wav' hidden='true' autostart='true' loop='false'>"
  );
