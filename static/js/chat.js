...
function createChatBox(chatboxtitle,minimizeChatBox) {
	...
	.addClass("chatbox")
	.html('<div class="chatboxhead" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')"><div class="chatboxtitle"><b>'+chatboxtitle+'</b></div><div class="chatboxoptions"><b>--</b>&nbsp&nbsp&nbsp<a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\');"></textarea></div>')
	.appendTo($( "body" ));
	...
	$("#chatbox_"+chatboxtitle+" .chatboxtextarea").blur(function(){
        ...
        $.cookie('#chatbox_'+chatboxtitle+' .chatboxhead', 1, { path: '/', expires: -1 });
	});
