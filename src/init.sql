...
(127, 'Escudo antigo', 'Escudo usado por T.Magor', 'shield', 55, 583520, 'ancientshield.gif', 0, 145, 't', 'f', 't');
...
(131, 'Escudo do herói', 'Escudo usado por heróis.', 'shield', 60, 807520, 'heroshield.gif', 0, 170, 't', 'f', 't');
...
(138, 'Escudo das trevas', 'Usado por guerreiros malignos.', 'shield', 70, 2128000, 'nightmareshield.gif', 0, 205, 't', 'f', 't');
...
(149, 'Calça demoniaca', 'As calças do demônio.', 'legs', 53, 780000, 'demonlegs.gif', 0, 160, 't', 'f', 't');
...
(213, 'Exotic Amulet', 'Um artefato raro e misterioso, emanando uma aura única que intriga e encanta todos ao seu redor.', 'amulet', 75, 1350000, 'Exotic_Amulet.gif', 0, 310, 't', 'f', 't');
(214, 'Colar de Safira', 'Um elegante colar adornado com uma safira radiante, trazendo beleza e uma leve aura de serenidade.', 'amulet', 87, 1550000, 'Sapphire_Necklace.gif', 0, 425, 't', 'f', 't');
(215, 'Amuleto Teúrgico', 'Um talismã imbuído de magia divina, capaz de canalizar forças espirituais para proteger e fortalecer seu portador.', 'amulet', 99, 2750000, 'Enchanted_Theurgic_Amulet.gif', 0, 655, 't', 'f', 't');
(216, 'Colar de Rhodolith', 'Um colar adornado com uma rodolita cintilante, irradiando uma energia suave e revitalizante, símbolo de paixão e equilíbrio.', 'amulet', 117, 5100000, 'Rhodolith_Necklace.gif', 0, 825, 't', 'f', 't');
...
(218, 'Machado de Âmbar', 'Forjado com lâminas incrustadas em âmbar, este machado irradia uma energia quente e ancestral.', 'weapon', 151, 2100000, 'Amber_Axe.gif', 2, 310, 't', 'f', 't');
(219, 'Machado da Cobra', 'Ágil e mortal, este machado carrega a essência venenosa e traiçoeira das serpentes.', 'weapon', 163, 2750000, 'Cobra_Axe.gif', 2, 465, 't', 'f', 't');
(220, 'Asa de Corvo', 'Um artefato sombrio, leve como uma pluma, mas tão letal quanto o voo silencioso de um corvo à espreita.', 'weapon', 176, 3445000, 'Ravenwing.gif', 2, 675, 't', 'f', 't');
(221, 'Machadinha Sanguínea', 'Uma arma pequena, mas brutal, sedenta por sangue e imbuída com a fúria de batalhas passadas.', 'weapon', 194, 5600000, 'Sanguine_Hatchet.gif', 2, 860, 't', 'f', 't');
...
(233, 'Cajado da Distorção de Almas', 'Um cajado misterioso que distorce a essência espiritual, capaz de drenar a vida de seus inimigos e amplificar os poderes mágicos do portador.', 'weapon', 245, 16300000, 'Soultainter.gif', 3, 999, 't', 'f', 't');
(234, 'Cortadora de Almas', 'Uma espada sombria capaz de rasgar a essência espiritual de seus inimigos, deixando apenas o vazio por onde passa.', 'weapon', 245, 16300000, 'Soulcutter.gif', 2, 999, 't', 'f', 't');
(235, 'Balestra Perfuradora de Almas', 'Uma balestra precisa e mortal, projetada para disparar virotes que não apenas perfuram a carne, mas também atravessam a essência espiritual das vítimas.', 'weapon', 255, 16300000, 'Soulpiercer.gif', 1, 999, 't', 'f', 't');
...
(242, 'Armadura do Demônio Verde', 'Forjada com energia sombria, esta armadura exala uma aura maligna que inspira medo e fortalece seu portador.', 'armor', 105, 2400000, 'Green_Demon_Armor.gif', 0, 235, 't', 'f', 't');
(243, 'Carapaça das Almas', 'Uma armadura mística que aprisiona fragmentos de almas, proporcionando proteção espiritual e poder além do plano mortal.', 'armor', 113, 3100000, 'Soulshell.gif', 0, 290, 't', 'f', 't');
(244, 'Swamplair Armor', 'Esta armadura emana a umidade e o odor dos pântanos profundos, conferindo resistência a venenos e ataques furtivos.', 'armor', 121, 3650000, 'Swamplair_Armor.gif', 0, 335, 't', 'f', 't');
(245, 'Armadura do Gnomo', 'Uma armadura compacta e leve, projetada para garantir agilidade e proteção às pequenas criaturas que a utilizam.', 'armor', 129, 3950099, 'Gnome_Armor.gif', 0, 420, 't', 'f', 't');
(246, 'Voltage Armor', 'Carregada com eletricidade instável, esta armadura amplifica o poder ofensivo enquanto atordoa inimigos que ousam se aproximar.', 'armor', 136, 4235000, 'Voltage_Armor.gif', 0, 510, 't', 'f', 't');
(247, 'Armadura de Pele Mutante', 'Criada a partir de uma substância viva e em constante transformação, oferece regeneração rápida e adapta-se aos ataques recebidos.', 'armor', 144, 4750090, 'Mutated_Skin_Armor.gif', 0, 625, 't', 'f', 't');
(248, 'Rainbow Necklace', 'Um colar mágico que brilha com as cores do arco-íris, concedendo força e resistência ao portador, enquanto encanta todos ao redor com sua beleza encantadora.', 'amulet', 129, 7000000, 'Rainbow_Necklace.gif', 0, 999, 't', 'f', 't');
(249, 'Manto de Penas', 'Um manto leve e gracioso feito das penas de cisnes sagrados, imbuindo o usuário com agilidade e uma aura de serenidade, como se pudesse flutuar sobre o campo de batalha.', 'armor', 175, 12000000, 'Swan_Feather_Cloak.gif', 0, 999, 't', 'f', 't');
(250, 'Armadura Nativa', 'Uma armadura ancestral que conecta o portador à natureza, imbuindo-o com resistência e o poder das florestas.', 'armor', 153, 5212620, 'Native_Armor.gif', 0, 710, 't', 'f', 't');
(252, 'Botas de Viajante', 'Botas duráveis e práticas, projetadas para enfrentar os rigores da jornada, garantindo conforto e proteção em cada passo.', 'boots', 70, 725000, 'Makeshift_Boots.gif', 0, 210, 't', 'f', 't');
(251, 'Abraço da Natureza', 'Um traje abençoado pelos espíritos da floresta, envolvendo o usuário com uma proteção viva e regeneradora, como se a própria natureza o abraçasse em defesa.', 'armor', 161, 7900000, 'Embrace_of_Nature.gif', 0, 845, 't', 'f', 't');
(253, 'Botas de Contenção', 'Botas criadas a partir de materiais reciclados, oferecendo conforto e durabilidade, perfeitas para aventuras inesperadas.', 'boots', 77, 845000, 'Make-do_Boots.gif', 0, 275, 't', 'f', 't');
(254, 'Botas da Terra', 'Botas robustas e resistentes, feitas para enfrentar os terrenos mais difíceis, proporcionando estabilidade e tração em qualquer ambiente.', 'boots', 81, 966000, 'Terra_Boots.gif', 0, 330, 't', 'f', 't');
(255, 'Botas Sanguíneas', 'Botas de couro macio tingidas de vermelho profundo, conferindo ao portador uma aura de poder e uma conexão com a energia vital da batalha.', 'boots', 90, 1200000, 'Sanguine_Boots.gif', 0, 445, 't', 'f', 't');
(256, 'Botas do Retorno', 'Botas acolhedoras que trazem conforto e proteção, permitindo ao viajante encontrar o caminho de volta para casa com cada passo.', 'boots', 96, 1600000, 'Boots_of_Homecoming.gif', 0, 625, 't', 'f', 't');
(257, 'Botas da Flor Feverosa', 'Botas enfeitadas com pétalas vibrantes, emanando energia mágica que aumenta a agilidade e a destreza do portador em combate.', 'boots', 104, 2100000, 'Feverbloom_Boots.gif', 0, 755, 't', 'f', 't');
(258, 'Pair of Soulstalkers', 'Um par de botas sombrias que permitem ao portador se mover silenciosamente, sussurrando entre as sombras enquanto persegue suas presas com precisão mortal.', 'boots', 114, 4000000, 'Pair_of_Soulstalkers.gif', 0, 999, 't', 'f', 't');
(259, 'Calças Eldritch', 'Calças mágicas que aumentam a agilidade e conectam o usuário às forças arcanas.', 'legs', 62, 910000, 'Eldritch_Breeches.gif', 0, 210, 't', 'f', 't');
(260, 'Pernas de Gnomo', 'Calças práticas com bolsos, perfeitas para os gnomos e suas invenções.', 'legs', 70, 1200000, 'Gnome_Legs.gif', 0, 295, 't', 'f', 't');
(261, 'Calças do Demonio Verde', 'Calças robustas e sinistras, adornadas com símbolos demoníacos, que conferem força e agilidade sobrenaturais ao portador.', 'legs', 79, 1650000, 'Green_Demon_Legs.gif', 0, 345, 't', 'f', 't');
(262, 'Calças Sanguíneas', 'Calças de um vermelho profundo que emanam uma aura poderosa, aumentando a força e a resistência do portador em combate.', 'legs', 85, 2100000, 'Sanguine_Legs.gif', 0, 410, 't', 'f', 't');
(263, 'Passos da Alma', 'Calças etéreas que permitem ao portador mover-se com uma agilidade sobrenatural, como se estivesse em sintonia com o mundo espiritual.', 'legs', 91, 3125000, 'Soulstrider.gif', 0, 525, 't', 'f', 't');
(264, 'Calças de Pele Mutante', 'Calças grotescas feitas de pele distorcida, oferecendo ao portador resistência extra e uma aparência aterradora.', 'legs', 99, 3585000, 'Mutated_Skin_Legs.gif', 0, 660, 't', 'f', 't');
(265, 'Calças das Almas', 'Calças imbuídas com energias espectrais, permitindo ao portador passos silenciosos e agilidade furtiva.', 'legs', 106, 4100000, 'Soulshanks.gif', 0, 745, 't', 'f', 't');
(266, 'Calças dos Anciões', 'Calças lendárias que carregam o poder e a sabedoria dos antigos, aumentando a defesa e a resistência do portador.', 'legs', 133, 8000000, 'Trousers_of_the_Ancients.gif', 0, 999, 't', 'f', 't');
(267, 'Grevas do Falcão', 'Calças leves e resistentes que concedem agilidade e visão aguçada, como a de um falcão em caça.', 'legs', 113, 5530400, 'Falcon_Greaves.gif', 0, 830, 't', 'f', 't');
(268, 'Coroa Arbórea', 'Uma coroa feita de ramos encantados, conectando o portador à força vital das florestas e concedendo regeneração natural.', 'helmet', 64, 145000, 'Arboreal_Crown.gif', 0, 135, 't', 'f', 't');
(269, 'Elmo da Coroa', 'Um elmo majestoso em forma de coroa, simbolizando autoridade e oferecendo proteção robusta ao portador.', 'helmet', 70, 185000, 'Crown_Helmet.gif', 0, 185, 't', 'f', 't');
(270, 'Capuz Eldritch', 'Um capuz místico que envolve o portador em sombras arcanas, aumentando seus poderes mágicos e ocultando sua presença.', 'helmet', 77, 265000, 'Eldritch_Hood.gif', 0, 235, 't', 'f', 't');
(271, 'Sabedoria Épica', 'Um chapéu de bruxo adornado com runas antigas, infundindo o portador com poder arcano e uma compreensão mística além do comum.', 'helmet', 81, 410000, 'The_Epic_Wisdom.gif', 0, 330, 't', 'f', 't');
(272, 'Máscara Divina', 'Uma máscara sagrada que emana uma aura celestial, concedendo proteção espiritual e elevando o poder do portador em combate.', 'helmet', 110, 1900000, 'Yalahari_Mask.gif', 0, 430, 'f', 'f', 'f');
(273, 'Máscara do Espelho', 'Uma máscara reflexiva que distorce a realidade, permitindo ao portador confundir inimigos e desviar ataques com facilidade.', 'helmet', 89, 609400, 'Mirror_Mask.gif', 0, 470, 't', 'f', 't');
(274, 'Elmo do Arcanomante', 'Um elmo magnífico que canaliza energias arcanas, aumentando o poder mágico do portador e protegendo sua mente contra feitiços adversos.', 'helmet', 94, 1230000, 'Arcanomancer_Regalia.gif', 0, 585, 't', 'f', 't');
(275, 'Manto do Desespero', 'Um elmo envolto em sombras, que enfraquece a coragem dos inimigos e fortalece o espírito do seu portador.', 'helmet', 115, 12000000, 'Shroud_of_Despair.gif', 0, 999, 't', 'f', 't');
(276, 'Visagem dos Dias Finais', 'Uma máscara sombria que representa o crepúsculo do mundo, conferindo ao portador poder sobre o destino e a habilidade de prever o futuro.', 'helmet', 99, 2100000, 'Visage_of_the_End_Days.gif', 0, 730, 't', 'f', 't');
(277, 'Elmo do Demônio Verde', 'Um elmo sinistro com detalhes em verde vibrante, que oferece proteção sobrenatural e uma aura intimidadora ao portador.', 'helmet', 104, 3345000, 'Green_Demon_Helmet.gif', 0, 810, 't', 'f', 't');
(278, 'Escudo Arco-Íris', 'Um escudo colorido que reflete a luz em todas as direções, conferindo ao portador proteção vibrante e a capacidade de desviar feitiços.', 'shield', 115, 12000000, 'Rainbow_Shield.gif', 0, 999, 't', 'f', 't');
(279, ' Escudo do Senhor dos Ossos', 'Um escudo macabro feito de ossos antigos, oferecendo proteção robusta e uma aura de intimidação para aqueles que se aproximam.', 'shield', 77, 2750000, 'Bonelord_Shield.gif', 0, 310, 't', 'f', 't');
(280, 'Escudo de Latão', ' Um escudo resistente de latão polido, combinando durabilidade com um brilho distintivo, ideal para defensores em batalha.', 'shield', 81, 3100000, 'Brass_Shield.gif', 0, 410, 't', 'f', 't');
(281, 'Escudo da Coroa', 'Um escudo majestoso adornado com símbolos de realeza, oferecendo proteção poderosa e um toque de nobreza ao portador.', 'shield', 88, 3500000, 'Crown_Shield.gif', 0, 510, 't', 'f', 't');
(282, 'Escudo do Espelho Assombrado', 'Um escudo sombrio com um espelho amaldiçoado, que reflete a essência dos inimigos, causando confusão e protegendo o portador com mistérios sombrios.', 'shield', 93, 4100000, 'Haunted_Mirror_Piece.gif', 0, 625, 't', 'f', 't');
(283, 'Bastião das Almas', 'Um escudo poderoso imbuído com a energia de almas antigas, proporcionando defesa impenetrável e proteção espiritual ao portador.', 'shield', 99, 4850000, 'Soulbastion.gif\n', 0, 705, 't', 'f', 't');
(284, 'Espírito do Dragão', 'Um escudo lendário infundido com a força e a fúria de um dragão, conferindo ao portador resistência imensa e um poder ancestral.', 'shield', 105, 5350000, 'The_Dragon_Spirit.gif', 0, 835, 't', 'f', 't');
(285, 'Amuleto da Cobra', 'Um amuleto místico com a forma de uma cobra, concedendo agilidade e reflexos rápidos ao portador, além de uma proteção venenosa.', 'amulet', 95, 2100000, 'The_Cobra_Amulet.gif', 0, 525, 't', 'f', 't');
(286, 'Espada do Pico de Energia', 'Uma espada infundida com poder energético, capaz de liberar rajadas elétricas que aumentam o dano e atordoam os inimigos.', 'weapon', 255, 12000000, 'Energy_Spike_Sword.gif', 0, 999, 't', 'f', 't');
(288, 'Aljava', 'Um recipiente para carregar flechas, ideal para arqueiros em combate.', 'quiver', 5, 1000, 'quiver.gif', 0, 0, 'f', 'f', 't');
(289, 'Aljava Vermelha', 'Uma aljava de cor vibrante, perfeita para arquearia com estilo e precisão.', 'quiver', 8, 2000, 'Red_Quiver.gif', 0, 25, 'f', 'f', 't');
(290, 'Aljava Azul', 'Uma aljava de tom azul profundo, ideal para armazenar flechas com agilidade e precisão.', 'quiver', 14, 10000, 'Blue_Quiver.gif', 0, 45, 'f', 'f', 't');
(291, 'Aljava Alicorn', 'Uma aljava mágica e única, inspirada no místico alicorn, perfeita para arqueiros lendários.', 'quiver', 18, 14000, 'Alicorn_Quiver.gif', 0, 60, 'f', 'f', 't');
(292, 'Aljava Eldritch', 'Uma aljava com um toque sobrenatural, impregnada com poder arcano para flechas de destruição.', 'quiver', 24, 26000, 'Eldritch_Quiver.gif', 0, 85, 't', 'f', 't');
(293, 'Aljava Confeitada', 'Uma aljava colorida e doce, com um design encantador que traz leveza e diversão aos arqueiros.', 'quiver', 44, 125000, 'Candy-Coated_Quiver.gif', 0, 165, 't', 'f', 't');
(294, 'Aljava da Selva', 'Forjada com materiais da natureza selvagem, perfeita para arqueiros que dominam o terreno da selva', 'quiver', 65, 330000, 'Jungle_Quiver.gif\n', 0, 310, 't', 'f', 't');
(295, 'Aljava Naga', 'Uma aljava mística, inspirada nas serpentes marinhas, ideal para flechas rápidas e venenosas.', 'quiver', 75, 1200000, 'Naga_Quiver.gif', 0, 510, 't', 'f', 't');
