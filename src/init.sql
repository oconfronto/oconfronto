...
(151, 'Espada de Friden', 'Espada usada por Friden, maior guerreiro de todos os tempos, esta espada possui poderes místicos tão fortes, que apenas um guerreiro muito poderoso pode controlá-la.', 'weapon', 149, 3500000, 'fridensword.gif', 2, 280, 'p', 'f', 'f'),
(152, 'Cajado do Drácula. ', 'Cajado usado pelo Drácula, com poderes tão surpreendentes que apenas um guerreiro muito poderoso pode manipulá-la.', 'weapon', 149, 3500000, 'draculawand.gif', 3, 280, 'p', 'f', 'f'),
(153, 'Arco de Baltazar', 'Arco usado por Baltazar, o melhor arqueiro, poderia atingir um alvo a quilômetros de distancia, para poder usá-lo você precisa ser muito preciso.', 'weapon', 163, 3710000, 'baltazarbow.gif', 1, 280, 'p', 'f', 'f'),
...
(269, 'Aljava', 'Aljava simples que armazena flechas com praticidade e agilidade.', 'quiver', 7, 1000, 'Quiver.gif', 1, 10, 'f', 'f', 't');
(270, 'Aljava Vermelha', 'Aljava reforçada que aumenta precisão e dano com energia ardente.', 'quiver', 12, 7000, 'Red_Quiver.gif', 1, 25, 'f', 'f', 't');
(271, 'Aljava Azul', 'Aljava encantada que melhora precisão e suaviza os movimentos.', 'quiver', 17, 12000, 'Blue_Quiver.gif', 1, 40, 'f', 'f', 't');
(272, 'Aljava de Alicórnio', 'Aljava mágica que confere precisão divina e flechas celestiais.', 'quiver', 21, 45000, 'Alicorn_Quiver.gif', 1, 85, 't', 'f', 't');
(273, 'Aljava da Selva', 'Aljava resistente que aumenta agilidade e precisão em terrenos selvagens.', 'quiver', 26, 135000, 'Jungle_Quiver.gif', 1, 145, 't', 'f', 't');
(274, 'Aljava Eldritch', 'Aljava sombria que aprimora flechas com magia arcana e energia mística.', 'quiver', 31, 220000, 'Eldritch_Quiver.gif', 1, 265, 't', 'f', 't');
(297, 'Anel do Poder', 'Um anel imbuído de energia pura, que aumenta a força e a resistência do portador.', 'ring', 0, 1000000, 'Power_Ring.gif', 0, 300, 't', 'f', 't');
(275, 'Aljava Revestida de Doce', 'Aljava encantada que aumenta temporariamente a velocidade e precisão.', 'quiver', 44, 310000, 'Candy-Coated_Quiver.gif', 1, 315, 't', 'f', 't');
(276, 'Aljava Naga', 'Aljava com escamas de Naga, que imbuem as flechas com veneno e aumentam a resistência.', 'quiver', 51, 700000, 'Naga_Quiver.gif', 1, 455, 't', 'f', 't');
