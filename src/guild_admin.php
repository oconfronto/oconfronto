...
<fieldset>
    ...
    <p />
    <table width="100%">
        <form action="sendfiles.php?cla=true" method="post" enctype="multipart/form-data">
            <tr>     
        ...
        <form method="POST" action="guild_admin.php">
            ...
            <tr>
                ...
                <td>
                    ...
                    <script>edToolbar('blurb'); </script><textarea onkeyup="contador(this.id,'alvo',5000);" rows="12"
