...
*/
	...
	#Total items
	public function items($value): void
	{
	...
	#Current page
	public function currentPage($value): void
	{
		$this->page = (int) $value;
	}

	#How many adjacent pages should be shown on each side of the current page?
	public function adjacents($value): void
	{
		$this->adjacents = (int) $value;
	}

	#show counter?
	public function showCounter($value = ""): void
	{
		$this->showCounter = $value === true;
	}

	#to change the class name of the pagination div
	public function changeClass($value = ""): void
	{
		$this->className = $value;
	}

	public function nextLabel($value): void
	{
		$this->nextT = $value;
	}

	public function nextIcon($value): void
	{
		$this->nextI = $value;
	}

	public function prevLabel($value): void
	{
		$this->prevT = $value;
	}

	public function prevIcon($value): void
	{
		$this->prevI = $value;
	}

	#to change the class name of the pagination div
	public function parameterName($value = ""): void
	{
