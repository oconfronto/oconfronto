...
<table width="100%" bgcolor="#f2e1ce">
	<tr>
		<td width="120px" bgcolor="#E1CBA4">
			<center><img src="static/<? echo $topicouser['avatar']; ?>" width="100px" height="100px" border="0"></center>
			<?php
			...
			?>
			<center>
				<font size="1px"><b><?php echo showName($topicouser['id'], $db); ?></b><br /><b>Posts:</b> <?php echo $topicouser['posts']; ?>
					<br /><?php
		...
		<td>
			<table width="95%" align="center">
				<tr>
					...
					<th width="30%" bgcolor="#E1CBA4">
						<font size="1px">
							<center><?php echo date("m/d/y", $rows['postado']);
									echo " &#224;s ";
									echo date("G:i", $rows['postado']); ?></center>
							<font>
					</th>
				</tr>
			</table>
					...
					<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#f2e1ce">
						...
						<tr>
							<td>
								<script>
									edToolbar('a_answer');
								</script><textarea name="a_answer" rows="6" id="a_answer" class="ed"></textarea>
							</td>
						</tr>
						<tr>
