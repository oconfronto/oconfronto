...
?>
    ...
    <table width="90%" align="center">
        <form method="POST" action="accpass.php">
            <tr>
                <td width="38%"><b>Senha atual</b>:</td>
                <td width="62%"><input type="password" name="oldpassword" class="inp" size="20" /></td>
            </tr>
            <tr>
                <td width="38%"><b>Nova senha</b>:</td>
                <td width="62%"><input type="password" name="password" class="inp" size="20" /></td>
            </tr>
            <tr>
                <td width="38%"><b>Digite novamente</b>:</td>
                <td width="62%"><input type="password" name="password2" class="inp" size="20" /></td>
            </tr>
    </table>
    <br />
    <center><button type="submit" name="changepassword" value="Atualizar" class="atualizar"></button></center>
    </form>
    <p />
<?php
} else {
