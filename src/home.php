...
echo "<table width=\"100%\">";
				...
				echo "<tr><td><b>Registrado:</b></td><td>" . date("d", $player->registered) . " de " . $mes_ano[$mes] . " de " . date("Y, g:i A", $player->registered) . ".</td></tr>";
                        ...
                        echo "</td></tr>";
                                if($player->magic_points > 29){
                                    ...
                                    echo "<center><font size=\"1px\"><b>Pontos místicos:</b> " . $player->magic_points . "</font></center>";
                                echo "</td></tr>";
			echo "<tr><td>";
	...
	echo "<td width=\"40%\">";
		echo "<table width=\"100%\">";
			...
			echo "</div></td></tr>";
			echo "<tr><td "; if($player->stat_points > 8){ echo "class=\"red\""; }else{ echo "class=\"on\""; } echo "><center><font size=\"1px\"><b><a href=\"stat_points.php\">Distribuir pontos</a></b></font></center>";
    echo "</td>";
