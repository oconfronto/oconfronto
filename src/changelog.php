<?php
include("lib.php");
define("PAGENAME", "MudanÁas Recentes");
...
if(!$_GET['confirm'] == yes){
echo showAlert("Deseja realmente deletar este log? <a href='?delid=$id_log&confirm=yes'>Sim</a> | <a href='changelog.php'>N„o</a>", "red");
}
if($_GET['confirm'] == yes){
...
echo showAlert("Log n„o encontrado", "red");
}
}
...
<tr>
<td class="brown" >
<b>Lista de AlteraÁıes</b>
<img src="images/help.gif" title="header=[InformaÁ„o] body=[<font size='1px'>Veja abaixo a lista de todas as alteraÁıes no game que foram feita ou est„o em andamento.</font>]">
...
<b>Coment·rio:</b> <?php echo $member['descricao'] ?>
<?php
...
<tr>
<td width="80%">
<font size="2px">N„o foram encontrado dados disponÌveis<br>
