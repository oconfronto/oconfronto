...
<tr>
<td width="30%"><b>Conta:</b></td><td width="70%"><input type="text" class="inp" name="username" value="<?php echo $_POST['username']?>" size="20"><span id="erro"></span></td>
</tr>
<tr>
<td width="30%"><b>Senha:</b></td><td width="70%"><input type="password" name="password" class="inp" size="20"><span id="certo"></span></td>
</tr>
</table>
</p>
<center>
