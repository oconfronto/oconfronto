...
<tr><td style="vertical-align:middle"><b>Vitalidade:</b> <?=$player->vitality?></td><td style="vertical-align:middle">+ <input type="text" id="checkStatus2" name="vit" value="0" size="4" maxlength="4"/><input id="buttonAdd2" value="+" type="button"> <input id="buttonSub2" value="-" type="button" disabled="true"><img src="images/help.gif" title="header=[Vitalidade] body=[Adiciona +20 á sua vida e +5 pontos á sua mana total.]"> <?php echo $msg2; ?></td></tr>
