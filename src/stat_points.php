...
<table>
<tr><td style="vertical-align:middle"><b><?=$antigaforca?>:</b> <?=$player->strength?></td><td style="vertical-align:middle">+ <input type="text" id="checkStatus1" name="for" value="0" size="4" maxlength="4"/><input id="buttonAdd1" value="+" type="button"> <input id="buttonSub1" value="-" type="button" disabled="true"><img src="static/images/help.gif" title="header=[<?=$antigaforca?>] body=[Aumenta seu poder de ataque.]"> <?php echo $msg1; ?></td></tr>
<tr><td style="vertical-align:middle"><b>Vitalidade:</b> <?=$player->vitality?></td><td style="vertical-align:middle">+ <input type="text" id="checkStatus2" name="vit" value="0" size="4" maxlength="4"/><input id="buttonAdd2" value="+" type="button"> <input id="buttonSub2" value="-" type="button" disabled="true"><img src="static/images/help.gif" title="header=[Vitalidade] body=[Adiciona +20 á sua vida e +5 pontos á sua mana total.]"> <?php echo $msg2; ?></td></tr>
<tr><td style="vertical-align:middle"><b>Agilidade:</b> <?=$player->agility?></td><td style="vertical-align:middle">+ <input type="text" id="checkStatus3" name="agi" value="0" size="4" maxlength="4"/><input id="buttonAdd3" value="+" type="button"> <input id="buttonSub3" value="-" type="button" disabled="true"><img src="static/images/help.gif" title="header=[Agilidade] body=[Desvia de ataques de inimigos e da ataques multiplos com mais facilidade.]"> <?php echo $msg3; ?></td></tr>
<tr><td style="vertical-align:middle"><b>Resist&ecirc;ncia:</b> <?=$player->resistance?></td><td style="vertical-align:middle">+ <input type="text" id="checkStatus4" name="res" value="0" size="4" maxlength="4"/><input id="buttonAdd4" value="+" type="button"> <input id="buttonSub4" value="-" type="button" disabled="true"><img src="static/images/help.gif" title="header=[Resist&ecirc;ncia] body=[Aumenta sua defesa.]"> <?php echo $msg4; ?></td></tr>
</table>
</fieldset>
<p><center><input type="submit" name="add" value="Adicionar Pontos de Status"></center></p>
</form>
<br/>
<?php
if ($tutorial->recordcount() == 0){
