<?php
include("lib.php");
define("PAGENAME", "Concentra‹o do Cl‹");
  ...
  echo "<tr>";
	echo "<td><table width=\"100%\" class=\"brown\" id=\"nvbarra\" style='height:25px;'>";
  	echo "<tr>";
		...
		echo "<td width=\"30%\"><b>Vice-Lider:</b> "; if ($guild['vice'] != NULL){ echo "<a href=\"profile.php?id=" . $guild['vice']. "\">" . $guild['vice']. "</a>"; }else{ echo "Ninguêm"; } echo "</td>";
