...
if ($_GET['id'])
{
    ...
    if ($_GET['comprovante']) {
            ...
            if ($error == 0)
            {
                ...
                if ($query->recordcount() == 1) {
                    ...
                    if ($errormsg != 1) {
                        ...
                        echo "<span id=\"aviso-a\"><font size=\"1px\">Envie-nos o comprovante do seu pagamento e tenha seus créditos liberados mais rapidamente. (Opcional)</font></span>";
                    }
        ...
        if ($errormsg != 1) {
            ...
            echo "<span id=\"aviso-a\"><font size=\"1px\">Informe-nos a conta do personagem que deverá receber os créditos.</font></span>";
        }
