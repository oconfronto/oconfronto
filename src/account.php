...
?>
    <fieldset>
        <p />
        <legend><b>Alterar senha de transferência</b></legend>
        <p />
        <table width="100%">
            <form method="POST" action="account.php">
                <tr>
                    <td width="25%"><b>Senha da conta</b>:</td>
                    <td><input type="password" name="pass2" size="20" /></td>
                </tr>
                <tr>
                    <td width="25%"><b>Senha de transferência</b>:</td>
                    <td><input type="password" name="oldtrans" size="20" /></td>
                </tr>
                <tr>
                    <td width="25%"><b>Nova senha</b>:</td>
                    <td><input type="password" name="trans" size="20" /></td>
                </tr>
                <tr>
                    <td width="25%"><b>Digite novamente</b>:</td>
                    <td><input type="password" name="trans2" size="20" /></td>
                </tr>
                <tr>
                    <td colspan="2" align="center"><input type="submit" name="changetrans" value="Alterar"></td>
                </tr>
        </table>
        </form>
        <p />
