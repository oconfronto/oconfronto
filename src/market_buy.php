...
switch($_GET['act'])
{
	...
	case "buy":
		...
		if (($market['item_bonus'] > 2) and ($market['item_bonus'] < 6)){
		echo "<table width=\"100%\" bgcolor=\"#ECD1BC\">\n";
		}elseif (($market['item_bonus'] > 5) and ($market['item_bonus'] < 9)){
		...
		echo "<b>Defesa:</b> " . $marketataque . " <b>Vocação:</b> ";
				...
				elseif ($market['voc'] == 3 and $market['needpromo'] == 'f')
				{
				echo "Bruxo";
				}
				elseif ($market['voc'] == 1 and $market['needpromo'] == 't')
				{
				echo "Arqueiro";
				}
				elseif ($market['voc'] == 2 and $market['needpromo'] == 't')
				{
				echo "Guerreiro";
				}
				elseif ($market['voc'] == 3 and $market['needpromo'] == 't')
				{
				echo "Mago";
				}
				...
				elseif ($market['voc'] == 2 and $market['needpromo'] == 'p')
				{
				echo "Cavaleiro";
				}
				elseif ($market['voc'] == 3 and $market['needpromo'] == 'p')
				{
				echo "Arquimago";
				}
		...
		echo "</td><td width=\"15%\">";
		if (($market['type'] != 'ring') and ($market['type'] != 'potion') and ($market['type'] != 'addon')) {
