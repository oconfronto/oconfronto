...
if ($_GET['estender']) {
 ...
 if ($magiascount->recordcount() < 11) {
	...
	if ($player->magic_points > 0) {
     ...
     if ($player->magic_points > 0){ echo "<a href=\"javascript:void(0)\" onclick=\"javascript:LoadPage('swap_spells.php?estender=true', 'maxmana')\"><img src=\"static/images/addstat.png\" border=\"0px\"></a>"; }else{ echo '<img src="static/images/none.png" border="0px">'; }
