...
switch($_GET['p'])
{
    case "quests":
        ...
        if (($_GET['p'] != "bar") && ($_GET['p'] != "tasks")) {
            echo "<a href=\"tavern.php?p=quests\"><b>Quests</b></a> | "; } else { echo "<a href=\"tavern.php?p=quests\">Quests</a> | ";
            }
        if ($_GET['p'] == "tasks") {
            echo "<a href=\"tavern.php?p=tasks\"><b>Tarefas</b></a> | "; } else { echo "<a href=\"tavern.php?p=tasks\">Tarefas</a> | ";
            }
        if ($_GET['p'] == "bar") { echo "<a href=\"tavern.php?p=bar\"><b>Bar</b></a>"; } else { echo "<a href=\"tavern.php?p=bar\">Bar</a>";
        }
        echo "</p></center>";
