...
<table width="100%" border="0">
  <tr>
    <td class="off" onmouseover="this.className='on'" onmouseout="this.className='off'" height="200">
      <div align="center">
  ...
  <tr>
    ...
    <td class="off" onmouseover="this.className='on'" onmouseout="this.className='off'" height="200">
      <div align="center">
        ...
        <br /><strong>Trabalho</strong>
      </div>
    </td>
    <td class="off" onmouseover="this.className='on'" onmouseout="this.className='off'" height="200">
      <div align="center"><a href="images/ss/ss6.png" rel="lightbox[screens]"><img src="static/images/ss/ss6.png" width="180" height="160" border="2px" alt="Perfil" /></a><br />
