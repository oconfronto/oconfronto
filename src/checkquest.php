...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou no nível 99, e tem uma missão ‡ fazer. <a href=\"quest1.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou no nível 129, e tem uma missão ‡ fazer. <a href=\"quest4.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você está entre o nível 145 e 155, e tem uma missão ‡ fazer. <a href=\"quest5.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou do nível 300, e tem uma missão ‡ fazer. <a href=\"quest6.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou do nível 300, e tem uma missão ‡ fazer. <a href=\"quest7.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou do nível 300, e tem uma missão ‡ fazer. <a href=\"quest8.php\">Clique aqui</a>.</b></font>", "red");
}
...
{
	echo showAlert("<font size=\"1px\"><b>Você já passou do nível 300, e tem uma missão ‡ fazer. <a href=\"quest9.php\">Clique aqui</a>.</b></font>", "red");
}
?>