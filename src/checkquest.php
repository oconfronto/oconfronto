...
if ($player->level > 79 && $player->promoted == "f")
{
...
$checaquestring = $db->execute("select `id` from `quests` where `quest_id`=2 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 99 && $checaquestring->recordcount() == 0)
{
...
$checaquestring = $db->execute("select `id` from `quests` where `quest_id`=7 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 129 && $checaquestring->recordcount() == 0)
{
...
$chdrgdrg = $db->execute("select `id` from `quests` where `quest_id`=9 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 144 && $player->level < 156 && $chdrgdrg->recordcount() == 0)
{
...
if ($player->level > 239 && $player->promoted != "p")
{
	if ($player->voc == 'archer'){
		$voc = "Arqueiro Royal";
	} elseif ($player->voc == 'knight'){
...
$treinaquest1 = $db->execute("select `id` from `quests` where `quest_id`=14 and (`quest_status`=90 or `quest_status`=89) and `player_id`=?", [$player->id]);
if ($player->level > 299 && $treinaquest1->recordcount() == 0)
{
...
$treinaquest2 = $db->execute("select `id` from `quests` where `quest_id`=15 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 299 && $treinaquest1->recordcount() != 0 && $treinaquest2->recordcount() == 0)
{
...
$treinaquest3 = $db->execute("select `id` from `quests` where `quest_id`=17 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 299 && $treinaquest2->recordcount() != 0 && $treinaquest3->recordcount() == 0)
{
...
$treinaquest4 = $db->execute("select `id` from `quests` where `quest_id`=18 and `quest_status`=90 and `player_id`=?", [$player->id]);
if ($player->level > 299 && $treinaquest3->recordcount() != 0 && $treinaquest4->recordcount() == 0)
{
