...
<tr><td width="27%"><b>Conta</b>:</td><td><input type="password" name="conta" class="inp" value="
<?=$_POST['conta'];
" size="20"/></td></tr>
<tr><td width="27%"><b>Senha</b>:</td><td><input type="password" name="senhadaconta" class="inp" value="
<?=$_POST['senhadaconta'];
" size="20"/></td></tr>
